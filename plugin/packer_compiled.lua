...
_G.packer_plugins = {
  ...
  ReplaceWithRegister = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/ReplaceWithRegister",
  ...
  ["silicon.nvim"] = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/silicon.nvim",
  ...
  ["venn.nvim"] = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/venn.nvim",
    url = "https://github.com/jbyuki/venn.nvim"
  },
  vim = {
    loaded = true,
    path = "/Users/sam/.local/share/nvim/site/pack/packer/start/vim",
